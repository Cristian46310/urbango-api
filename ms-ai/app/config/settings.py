...
class Settings:
    ...
    SCOPES: list[str] = os.getenv("SCOPES", "https://www.googleapis.com/auth/calendar").split(";")
    ...
    CANCEL_URL_BASE: str = os.getenv("CANCEL_URL_BASE", "http://localhost:8001/api/appointments")
